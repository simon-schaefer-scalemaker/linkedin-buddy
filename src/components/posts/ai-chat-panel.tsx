...
export function AiChatPanel({ isOpen, onClose, postId, platform, currentPost }: AiChatPanelProps) {
  ...
  }, [isOpen, postId, platform, currentPost, messages.length, apiConfigured, addMessage])
  ...
  return (
    <>
      ...
      <div 
        className={cn(
          "fixed top-0 right-0 h-full w-[420px] bg-white shadow-xl z-50 flex flex-col transition-transform duration-200 ease-out",
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-[14px] font-medium text-gray-900">AI Assistent</h3>
              <p className="text-[11px] text-gray-400">{platformName} Content</p>
            </div>
          </div>
        ...
        {!apiConfigured ? (
          <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
            ...
            <h4 className="text-[14px] font-medium text-gray-900 mb-2">API-Key erforderlich</h4>
  ...
  return (
    <div className={cn("flex gap-3", !isAssistant && "flex-row-reverse")}>
      <div className={cn(
        ...
        isAssistant ? "bg-purple-100" : "bg-gray-100"
      )}>
        {isAssistant ? (
